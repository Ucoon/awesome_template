...
typedef ResponseProcessor = FutureOr<void> Function(Context context, dynamic result);

typedef RouteHandler<RespType> = FutureOr<RespType> Function(Context context);

/// Register this Navigator Route
///
/// [path] you want register path, such as: /user/:id   or /user/*
